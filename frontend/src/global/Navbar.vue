<template>
    <div style="position: fixed; width: 100%; z-index: 10">
        <b-navbar
            ...
            variant="info"
            type="light"
            style="height: 85px; border-radius: 0 0 15px 15px; box-shadow: 0 0 15px #242424;"
        >
            <b-navbar-brand
                style="width: 100%"
        ...
        <div
            ...
            class="flex-column align-items-center d-flex"
        ...
        >
            ...
            <b-button variant="warning" size="md" @click="logOut()"
                >Logout</b-button
            >
        </div>
    </div>
