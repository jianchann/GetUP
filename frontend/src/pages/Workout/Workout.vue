    ...
    <div class="workout-details-container">
      <div class="d-flex justify-content-between">
        ...
        <div class="d-flex flex-column" v-if="this.$store.state.admin">
          <b-button variant="secondary" size="md" v-b-modal.editWorkout>
            <i class="fas fa-edit"></i>
          </b-button>
          <b-button variant="secondary" size="md" v-b-modal.deleteWorkout>
      ...
      <div class="d-flex justify-content-between">
        ...
        <div>
          <h5>Duration</h5>
          <div class="text-right">{{ this.workout.duration }} minutes</div>
        </div>
      </div>
      <div class="d-flex justify-content-between mt-3">
        ...
        <div>
          ...
          <div class="text-right">{{ this.workout.people_count }} people</div>
        </div>
      </div>
      <div class="mt-3">
        <h5>Instructions</h5>
